...
class IXI(data.Dataset):
    ...
    # #       print(pd.DataFrame(self.original_files).iloc[:,0].value_counts())
        #    if N ==10:
        #        assert pd.DataFrame(self.original_files).iloc[:,0].value_counts().values[0] == 546
        #    elif N ==20:
        #        assert pd.DataFrame(self.original_files).iloc[:,0].value_counts().values[0] == 536
        #    elif N ==30:
        #        assert pd.DataFrame(self.original_files).iloc[:,0].value_counts().values[0] == 526


        #    assert pd.DataFrame(self.original_files).iloc[:,0].value_counts().values[0] == pd.DataFrame(self.original_files).iloc[:,0].value_counts().values[1]
